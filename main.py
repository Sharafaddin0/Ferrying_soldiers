print("Welcome to the popular Ferrying Soldiers from one bank of the river to another puzzle!")
"""
1. There are n number of soldiers on the left bank of the river. In my program, let's assume there are 20 soldiers.
2. There are 2 boys playing on the boat by shore
3. Boat can carry 1 adult 1 boy or 2 boys 

* Solution:
1. Firstly, 2 boys must row the boat to the right bank of the river, while 1 of them must return with the boat.
2. Then a single adult rows the boat to the other side and stays there while boy returns back with the boat again
3. These 4 trips reduces the problem size by 1
4. Generally, these four trips should be repeated 20 (n) times, it means that the puzzle will be solved after 80 trips (4n).
"""
